...
\begin{compactitem}
\item{Marktführer (Leader):}
\\Der Marktführer-Quadtrant stellt Anbieter dar, dessen Produkte die Marktanforderungen am besten bedienen, am meisten Umsatz generiert und sich somit durchgesetzt haben. Marktführer haben in der Regel einen relativ hohen Marktanteil, ein starkes Umsatzwachstum und positives Kunden-Feedback. Die Produkte der Marktführer verfügen gegenüber Anderer über eine überlegene Vision.
\item{Herausforderer (Challenger):}
\\Der Herausforderer-Quadrant zeigt Anbieter mit großem Umsatz, der aber eher auf anderen Produkten oder Dienstleistungen basiert. Ihr IaaS-Angebot ist eher moderat und wird einer Teilmenge der Marktanforderungen gerecht. Viele der angebotenen IaaS-Lösungen sind eine Erweiterung bereits bestehender Systeme.
\item{Visionäre (Visionairs):}
\\Der Visionäre-Quadrant besteht aus Anbietern, deren Produkte die Marktanforderungen gut abdecken, aber dessen Bewertung der Umsetzung nicht der der Marktführer entspricht. Dies liegt unter anderem auch an der relativ kleinen Präsenz auf dem IaaS-Markt.
\item{Nischenprodukt (Niche):}
\\Der Nischen-Quadrant zeigt vor allem kleine, regionale Anbieter, deren Fokus auf der Entwicklung von IaaS-Lösungen für einzelne Anwendungsfälle liegt. Die Marktanforderungen werden somit nur teilweise erfüllt.
\end{compactitem}

\subsubsection{Schnittstellenfestlegung}
Der Vergleich möglicher Schnittstellen zu Google Cloud Storage führte zu gsutil. 
