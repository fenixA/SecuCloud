...
\textbf{AES}\\
AES (Eng. Advanced Encryption Standard) ist ein Kryptosystem, welches im
...
Grundsätzlich ist AES ein symmetrisches Blockchiffresystem. Es arbeitet also bei
...
\begin{thebibliography}{xxxxxxxxxxxxxxxxxxx}
	...
	\bibitem[WJava]{2}\url{http://de.wikipedia.org/wiki/Java_%28Programmiersprache%29}
	...
	\bibitem[WAes]{5}\url{http://http://de.wikipedia.org/wiki/Advanced_Encryption_Standard}
\end{thebibliography}
