...
\subsubsection{Schlüsselmanagement durch Key-Server}
\subsubsection{Selbstsynchronisierung}
\subsubsection{Blockweise Verschlüsselung}
\subsubsection{Rechteverwaltung}
\subsection{Erweiterung der Benutzeroberfläche}
\subsubsection{Ausbau des Designs}
