...
Zunächst werden im Kapitel \ref{MethodenV} Methoden alle Grundlagen erläutert, die zum Verständnis der entwickelten Applikation, des Sicherheitskonzeptes und der Entscheidungen, die auf dem Weg dorthin getroffen wurden, notwendig sind. Hier geht es vor allem um die verwendeten Sicherheitsalgorithmen, die Notwendigkeit von Cloudcomputing, dessen wirtschafliche Aspekte und Abgrenzung der verschiedenen Anbieter sowie die zur Entwicklung der Applikation verwendeten Werkzeuge und Technologien. Nachfolgen wird in \ref{ErgebnisseV} Ergebnisse die Applikation selbst in Architektur und Aufbau des Programmcodes und das entworfene Sicherheitskonzept erläutert. Außerdem findet sich hier auch eine detaillierte Beschreibung des graphischen Interfaces und eine Bedienungsanleitung. In \ref{DiskussionV} Diskussion werden die Ergebnisse (die Applikation) im Sinne der Motivation und der Zielsetzung bewertet, sowie Möglichkeiten zur Optimierung der Applikation und eine Aussicht auf zukünftige Weiterentwicklungen gegeben.
...
% Methoden
% ----------------------------------------------------------------------------------------------------------
\section{Methoden}\label{MethodenV}
...
\begin{minipage}{\linewidth}
	...
	\includegraphics[width=1.0\linewidth]{Wirtschaftlichkeit.jpg}
	 \captionof{figure}{\small Wirtschaftlichkeit {\cite{39}}}
...
<<<<<<< HEAD
\subsubsection{Schnittstelle Google Cloud Storage: gsutil}\label{GsutilV}
...
% ----------------------------------------------------------------------------------------------------------
 ...
 \begin{thebibliography}{xxxxxxxxxxxxxxxxxxx}
	...
	\bibitem[ArchiveJava]{2}\url{http://web.archive.org/web/20100105045840/http://java.sun.com/features/1998/05/birthday.html}
	\bibitem[JavaInsel]{3}\url{ openbook.galileocomputing.de/javainsel}
	...
	\bibitem[NistCTR]{6}\url{http://csrc.nist.gov/publications/nistpubs/800-38a/sp800-38a.pdf}
	\bibitem[NistCTRSpec]{7}\url{http://csrc.nist.gov/groups/ST/toolkit/BCM/documents/proposedmodes/ctr/ctr-spec.pdf}
	...
	\bibitem[GCS]{40} \url{https://cloud.google.com/storage/docs/overview#blocks}
