...
Zwischenzeitlich gab es Überlegungen dahin gehen, dass aus der Applikation eine Art Teamplattform mit versionsverwaltung zu schaffen. Alleine die Berechnung und Verwaltung der Changesets hätte den Rahmen dieser Projektarbeit gesprengt, allerdings kam in diesem Zusammenhang die Idee auf, Verschlüsselungskaskaden aufzubauen:
In diesem Falle müssten die Dateien asymmetrisch verschlüsselt werden, TODO
