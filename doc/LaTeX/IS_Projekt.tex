...
\begin{minipage}{\linewidth}
	...
	\includegraphics[width=0.7\linewidth]{Auslastung.jpg}
	 \captionof{figure}{\small Bedarfsschwankungen in der Ressourcenauslastung}
\end{minipage}
\vspace{1em}
